...
def gazelle_ws():
    ...
    go_repository(
        ...
        sum = "h1:0WWUDZ1oxq7NxVyGo8M3KI5jbkiwNAdZFFzAdC68up4=",
        version = "v2.0.1-0.20201017141208-acf90d56d591",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:RPclfga2SEJmgMmz2k+Mg7cowZ8yv4Trqw9UsJby758=",
    ...
    go_repository(
        ...
        sum = "h1:9BBjVJTRxuYBeCAv9DFH2hSzY0ujLx5sxMg5D3K/Xeg=",
        version = "v0.0.0-20201018122409-d551c850a743",
    )
    go_repository(
